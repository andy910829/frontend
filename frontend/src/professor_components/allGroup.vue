...
export default {
  ...
  methods: {
    ...
    getAllGroups() {
      ...
      axios
        .post(path, { pro_name: sessionStorage.getItem("name"),acedemic_year:this.acedemicYear,token:sessionStorage.getItem("token"),act: sessionStorage.getItem("user_account")})
        .then((response) => {
