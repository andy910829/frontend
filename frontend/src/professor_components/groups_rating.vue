          ...
          <div class="card-side-components">
            ...
            <div class="nextside-score">
              ...
              <input
                ...
                v-model="groupAns[GroupInfo.leader.student_id]"
                @input="
                  nextchangeFromInput($event, GroupInfo.leader.student_id)
                "
              />
              <div v-for="member in GroupInfo.member" class="member-area">
                ...
                <input
                  ...
                  v-model="groupAns[member.student_id]"
